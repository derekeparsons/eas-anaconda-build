# create-adm-dev.sh
#
#  Creates the adm/dynamics anaconda development environment
#    (adm + jupytext for notebook development)
#
...
conda install -c conda-forge metpy siphon python-wget cfgrib jupytext matplotlib=3.3.3 -y
